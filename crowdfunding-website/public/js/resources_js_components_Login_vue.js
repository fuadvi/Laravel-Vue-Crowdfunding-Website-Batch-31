  ...
  data: function data() {
    return {
      ...
      emailRules: [function (v) {
        return !!v || 'E-email is required';
      }, function (v) {
        return /([a-zA-Z0-9_]{1,})(@)([a-zA-Z0-9_]{2,}).([a-zA-Z0-9_]{2,})+/.test(v) || 'E-email must be valid';
      }],
      showPassword: false,
      password: '',
  ...
  methods: _objectSpread(_objectSpread({}, (0,vuex__WEBPACK_IMPORTED_MODULE_1__.mapActions)({
    ...
    submit: function submit() {
      ...
      if (this.$refs.form.validate()) {
        ...
        axios__WEBPACK_IMPORTED_MODULE_0___default().post('/api/auth/login', formData).then(function (res) {
        ...
        [
          _c(
            ...
            [
              ...
              _c("v-text-field", {
                attrs: {
                  "append-icon": _vm.showPassword ? "mdi-aye" : "mdi-aye-close",
